...
import React, { CSSProperties, forwardRef, ElementType, ComponentPropsWithRef, ForwardRefExoticComponent, RefAttributes } from 'react';
...
type ComponentProps<T extends ElementType> = {
    as?: T;
} & Omit<ComponentPropsWithRef<T>, keyof FlexProps> & 
    FlexProps & 
    SpacingProps & 
    SizeProps & 
    StyleProps & 
...
type FlexComponent = <T extends ElementType = typeof defaultElement>(
    props: ComponentProps<T>
) => React.ReactElement | null;

const Flex = forwardRef(function Flex<T extends ElementType = typeof defaultElement>(
    {
        as,
        direction,
        justifyContent,
...
}) as ForwardRefExoticComponent<ComponentProps<ElementType>> & { displayName: string };
